...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        backgroundColor:
            _isLoading ? DeckColors.softGreen : DeckColors.backgroundColor,
        body: _isLoading
                ...
                children: [
                  Stack(
                    children: [
                      Image(
                        image:
                            const AssetImage('assets/images/Deck-Header.png'),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: InkWell(
                            ...
                            splashColor:
                                DeckColors.primaryColor.withOpacity(0.2),
                            child: const Padding(
                        ...
                        BuildButton(
                            onPressed: () async {
                              ...
                              try {
                                ...
                                if (token != null) {
                                  const batchSize =
                                      1000; // Adjust based on your preference
                                  for (int i = 0;
                                      i < token.length;
                                      i += batchSize) {
                            ...
                            try {
                              ...
                              if (token != null) {
                                ...
                                for (int i = 0;
                                    i < token.length;
                                    i += batchSize) {
                                  String batch = token.substring(
                                      i,
                                      i + batchSize > token.length
                                          ? token.length
                                          : i + batchSize);
                                  print(batch);
                                }
                  ...
                  Image(
                    image: const AssetImage(
                        'assets/images/Deck-Bottom-Image3.png'),
                    width: MediaQuery.of(context).size.width,
                    height: 80,
                    fit: BoxFit.fill,
                  ),
